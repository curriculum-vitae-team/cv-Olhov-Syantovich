...
columnsSetting[TableEmployeeEnum.department] = { headerName: 'Department', sx: { width: 50 } };
columnsSetting[TableEmployeeEnum.position] = { headerName: 'Position', sx: { width: 200 } };
